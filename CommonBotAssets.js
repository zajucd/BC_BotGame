...
//监听移动信息
ServerSocket.on("ChatRoomSyncMapData", function (data) { ChatRoomMapViewSyncMapAdd(data); });
if (typeof ChatRoomMessageAdditionDict === 'undefined') {
  ChatRoomMessageAdditionDict = {}
}

if (typeof ChatRoomSyncMapDataAdditionDict === 'undefined') {
...
function ChatRoomMapViewSyncMapAdd(data) {
